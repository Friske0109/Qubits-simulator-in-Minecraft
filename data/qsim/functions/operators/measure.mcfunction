...
scoreboard players operation qubits0 qubits *= qubits0 qubits
scoreboard players operation qubits1 qubits *= qubits1 qubits
scoreboard players operation qubits2 qubits *= qubits2 qubits
scoreboard players operation qubits3 qubits *= qubits3 qubits
scoreboard players operation qubits4 qubits *= qubits4 qubits
scoreboard players operation qubits5 qubits *= qubits5 qubits
scoreboard players operation qubits6 qubits *= qubits6 qubits
scoreboard players operation qubits7 qubits *= qubits7 qubits
scoreboard players operation qubits8 qubits *= qubits8 qubits
scoreboard players operation qubits9 qubits *= qubits9 qubits
scoreboard players operation qubits10 qubits *= qubits10 qubits
scoreboard players operation qubits11 qubits *= qubits11 qubits
scoreboard players operation qubits12 qubits *= qubits12 qubits
scoreboard players operation qubits13 qubits *= qubits13 qubits
scoreboard players operation qubits14 qubits *= qubits14 qubits
scoreboard players operation qubits15 qubits *= qubits15 qubits

scoreboard players operation qubits_i0 qubits *= qubits_i0 qubits
scoreboard players operation qubits_i1 qubits *= qubits_i1 qubits
scoreboard players operation qubits_i2 qubits *= qubits_i2 qubits
scoreboard players operation qubits_i3 qubits *= qubits_i3 qubits
scoreboard players operation qubits_i4 qubits *= qubits_i4 qubits
scoreboard players operation qubits_i5 qubits *= qubits_i5 qubits
scoreboard players operation qubits_i6 qubits *= qubits_i6 qubits
scoreboard players operation qubits_i7 qubits *= qubits_i7 qubits
scoreboard players operation qubits_i8 qubits *= qubits_i8 qubits
scoreboard players operation qubits_i9 qubits *= qubits_i9 qubits
scoreboard players operation qubits_i10 qubits *= qubits_i10 qubits
scoreboard players operation qubits_i11 qubits *= qubits_i11 qubits
scoreboard players operation qubits_i12 qubits *= qubits_i12 qubits
scoreboard players operation qubits_i13 qubits *= qubits_i13 qubits
...
kill @e[tag=measure_choise,type=area_effect_cloud]
scoreboard players operation measure_range qubits = max_value qubits
scoreboard players operation measure_range qubits *= measure_range qubits
scoreboard players operation measure_random qubits %= measure_range qubits

execute if score measure_random qubits < qubits0 qubits run return 0
execute if score measure_random qubits < qubits1 qubits run return 1
execute if score measure_random qubits < qubits2 qubits run return 2
execute if score measure_random qubits < qubits3 qubits run return 3
execute if score measure_random qubits < qubits4 qubits run return 4
execute if score measure_random qubits < qubits5 qubits run return 5
execute if score measure_random qubits < qubits6 qubits run return 6
execute if score measure_random qubits < qubits7 qubits run return 7
execute if score measure_random qubits < qubits8 qubits run return 8
execute if score measure_random qubits < qubits9 qubits run return 9
execute if score measure_random qubits < qubits10 qubits run return 10
execute if score measure_random qubits < qubits11 qubits run return 11
execute if score measure_random qubits < qubits12 qubits run return 12
execute if score measure_random qubits < qubits13 qubits run return 13
execute if score measure_random qubits < qubits14 qubits run return 14
return 15
